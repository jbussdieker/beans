...
describe TransactionsController do
  ...
  let(:valid_attributes) { { "date" => "2014-03-02 20:33:38" } }
  ...
  describe "GET index" do
    it "assigns all transactions as @transactions" do
      transaction = @user.transactions.create! valid_attributes
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested transaction" do
        ...
        Transaction.any_instance.should_receive(:update).with({ "date" => "2014-03-02 20:33:38" })
        put :update, {:id => transaction.to_param, :transaction => { "date" => "2014-03-02 20:33:38" }}, valid_session
      end
